        ...
        <div class="bg-white rounded-3xl p-8 sm:p-12 border border-earth-200 shadow-2xl w-full max-w-lg">
            ...
            <form action="{{ route('register.post') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" class="w-full px-4 py-3 rounded-lg border border-earth-200 focus:outline-none focus:ring-2 focus:ring-earth-500 bg-earth-50" required>
                </div>
                <div>
